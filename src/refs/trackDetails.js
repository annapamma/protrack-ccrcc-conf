export default {
  ...
  consent_race: [
    ...
    { value: 6004, label: "Not Reported", color: "#ffffff", show: true },
  ],
  "Vital status": [
  ...
  BMI: [
    { value: 10001, label: "<25.585 (25%)", color: "#ffe169", show: true },
    {
      value: 10002,
    ...
    { value: 10004, label: ">=35.83 (>75%)", color: "#a47e1b", show: true },
  ],
  Weight_at_surgery: [
  ...
  alcohol_consumption: [
    { value: 12001, label: "past drinker", color: "#ffdab9", show: true },
    { value: 12002, label: "light drinker", color: "#f8ad9d", show: true },
    { value: 12003, label: "heavy drinker", color: "#f08080", show: true },
    { value: 12004, label: "non-drinker", color: "#ffff17", show: true },
    { value: 12005, label: "not reported", color: "#ffffff", show: true },
  ],
  smoking_history: [
    {
      value: 13001,
    ...
    { value: 13004, label: "current smoker", color: "#C04F3B", show: true },
    { value: 13005, label: "non-smoker", color: "#1A7ED4", show: true },
    { value: 13006, label: "not reported", color: "#ffffff", show: true },
  ],
  Country: [
    ...
    { value: 14005, label: "other", color: "#ffffff", show: true },
  ],
  Stage: [
    ...
    { value: 15005, label: "other", color: "#ffffff", show: true },
  ],
  methyl_type2: [
